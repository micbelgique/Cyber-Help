...
namespace SummerCamp.CyberHelp.DataServices.Helpers
{
    public class SqlDatabaseCommand  : Apps72.Dev.Data.DatabaseCommandBase
    {
        ...
        public SqlDatabaseCommand(SqlConnection connection)
            : this(connection, null, String.Empty, -1)
        {
        }
